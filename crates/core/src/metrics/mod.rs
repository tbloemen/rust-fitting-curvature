...
//! [`MetricValues`] holds one embedding's scores, and [`MetricContext`] carries
//! the inputs while deriving each distance matrix at most once.
//!
//! Metrics group into:
...
//! - **Spread** — r_max, r_rms, r_gyration, the diagnostics κ is gauged against
//!
...
pub use quality::{
    ...
    NEIGHBORHOOD_HIT_MANIFOLD, NORMALIZED_STRESS, NORMALIZED_STRESS_MANIFOLD, OBJECTIVES, R_GYRATION,
